package io.ift.automation.listener.testng;
...
public class SimpleWebDriverScreenShotTestListener extends AbstractWebDriverEventListener
    ...
    public void onException(Throwable throwable, WebDriver driver) {
        ...
        String errorStringShotPath = WebDriverHelper.ScreenShotUtils.takeScreenshotForSimpleReport(driver);
    ...
    public void beforeClickOn(WebElement element, WebDriver driver) {
        String screenshots= WebDriverHelper.ScreenShotUtils.takeScreenshotForSimpleReport(driver);
