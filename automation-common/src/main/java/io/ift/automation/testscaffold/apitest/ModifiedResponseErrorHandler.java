 ...
 */
public class ModifiedResponseErrorHandler implements ResponseErrorHandler {

    private static final Logger logger = LogManager.getLogger(ModifiedResponseErrorHandler.class.getName());
	...
	public void handleError(ClientHttpResponse response) throws IOException {
        ...
        logger.info("error_response={}",getHttpStatusCode(response).getReasonPhrase());
//		HttpStatus statusCode = getHttpStatusCode(response);
//		switch (statusCode.series()) {
//			case CLIENT_ERROR:
////				throw new HttpClientErrorException(statusCode, response.getStatusText(),
////						response.getHeaders(), getResponseBody(response), getCharset(response));throw new HttpClientErrorException(statusCode, response.getStatusText(),
